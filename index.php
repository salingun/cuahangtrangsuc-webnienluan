	...
	<div class="container">
		<div class="banner-main">
			<div class="col-md-6 banner-left">
				<a href="chitiet.php"><img src="images/ba.png" alt="" class="img-responsive"></a>
			</div>
			<div class="col-md-6 banner-right simpleCart_shelfItem">
				...
				<ul class="bann-small-img">
					<li><a href="chitiet.php"><img src="images/b1.jpg"></a></li>
					<li><a href="chitiet.php"><img src="images/b2.jpg"></a></li>
				</ul>
				<h6>Size Charts</h6>
				<ul class="bann-btns">
	...
	<div class="container">
		<div class="blc-layer3-main">
			   ...
			   <div class="col-md-4 blc-layer3-grids2">
			   	<a href="chitiet.php"><img src="images/bracelate.png" alt=""></a>
			   </div>
			   <div class="col-md-4 blc-layer3-grids-3 simpleCart_shelfItem">
				 <div class="box-grid">
				   	<h3><a href="chitiet.php">Brand</a></h3>
				   	<p>Nam libero tempore cum</p>
				   	<h5>At vero eos et accusamus iusto</h5>
				   	<a href="chitiet.php"><img src="images/w2.png" alt=""></a>
